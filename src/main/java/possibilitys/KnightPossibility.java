...
public class KnightPossibility {
    public static List<String> knightPossibility(Connection connection, Square square, Piece piece){
        ...
        int[] p1= {row+2, column+1};
        int[] p2= {row+2, column-1};
        int[] p3= {row-2, column+1};
        int[] p4= {row-2, column-1};
        int[] p5= {row+1, column+2};
        int[] p6= {row-1, column+2};
        int[] p7= {row+1, column-2};
        int[] p8= {row-1, column-2};
